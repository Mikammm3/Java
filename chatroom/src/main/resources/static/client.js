...
function addFriend(friendId, addReason) {
    ...
    addReason = document.querySelector(str);
    // console.log(str);
    ...
    //     console.log(messageSpan.getAttribute("friend-id"));
    //     if (messageInput.value != '') {
    //         console.log(user.userId);
    //         addFriend(messageSpan.getAttribute("friend-id"), messageInput.value);
    //         messageButton.innerHTML = "等待验证通过中...";
